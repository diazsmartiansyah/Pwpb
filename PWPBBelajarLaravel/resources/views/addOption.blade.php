...
<div class="col-md-10 mx-4 align-content-center">
    <h2><i class="fas fa-plus-square mr-2"></i>Tambah Data</h2><hr class="mr-1 bg-dark">
    ...
    <div class="row my-3">
            ...
            <div class="card text-center mx-5 bg-dark border-0 my-3" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <img class="card-img-center my-2 mb-3" width="260" height="175" src="{{ asset('img/students.png') }}">
            ...
            <div class="card text-center mx-5 bg-dark border-0 my-3" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <img class="card-img-center my-2" width="260" height="180" src="{{ asset('img/classes.png') }}">
